...
<template>
  <ve-card :title="props.title" divider>
      ...
      <ve-grid dense>
        ...
        >
          <ve-button
              ...
              rounded
              style="opacity: .8;"
              icon="svg:M12.89,3L14.85,3.4L11.11,21L9.15,20.6L12.89,3M19.59,12L16,8.41V5.58L22.42,12L16,18.41V15.58L19.59,12M1.58,12L8,5.58V8.41L4.41,12L8,15.58V18.41L1.58,12Z"
          />
        </ve-tooltip>
      </ve-grid>
    </template>
    ...
    <ve-lazy>
      <ve-material :theme="theme" size="auto" border="0">
        <ve-card-text>
          <slot />
        </ve-card-text>
      </ve-material>
